...
local IndexUIColor = {
	...
	["Setting Icon Color"] = Color3.fromRGB(255, 105, 180),
	["Logo Image"] = "rbxassetid://5009916777",
	["Search Icon Color"] = Color3.fromRGB(255, 105, 180),
	["Search Icon Highlight Color"] = Color3.fromRGB(255, 105, 180),
	["GUI Text Color"] = Color3.fromRGB(255, 105, 180),
	["Text Color"] = Color3.fromRGB(255, 105, 180),
	["Placeholder Text Color"] = Color3.fromRGB(178, 178, 178),
	["Title Text Color"] = Color3.fromRGB(255, 105, 180),
	["Background Main Color"] = Color3.fromRGB(255, 105, 180),
	["Background 1 Color"] = Color3.fromRGB(255, 105, 180),
	["Background 1 Transparency"] = 0.25,
	["Background 2 Color"] = Color3.fromRGB(90, 90, 90),
	["Background 3 Color"] = Color3.fromRGB(20, 20, 20),
	["Background Image"] = "",
	["Page Selected Color"] = Color3.fromRGB(255, 0, 0), -- Xanh lá trung bình
	["Section Text Color"] = Color3.fromRGB(255, 0, 0),
	["Section Underline Color"] = Color3.fromRGB(255, 0, 0),
	["Toggle Border Color"] = Color3.fromRGB(255, 0, 0),
	...
	["Dropdown Selected Check Color"] = Color3.fromRGB(255, 0, 0), -- Xanh lá sáng cho check
	["Textbox Highlight Color"] = Color3.fromRGB(255, 0, 0),
	["Box Highlight Color"] = Color3.fromRGB(255, 0, 0),
	["Slider Line Color"] = Color3.fromRGB(90, 138, 12), -- Xanh lá đậm cho nền slider
	["Slider Highlight Color"] = Color3.fromRGB(255, 0, 0), -- Xanh lá sáng cho slider fill
...
ToggleButton.Image = "rbxassetid://5009915812"
...
local libCreateNoti = function(Setting)
	...
	TextLabelNoti.Text = "<font color=\"rgb(" .. color .. ")\">Nana hub</font> "..cache.TitleNameNoti
...
function Library.CreateMain(Setting)
	...
	Ruafimg.Position = UDim2.new(0, 5, 0, cache.T1 and 5 or 0)
	Ruafimg.Size = UDim2.new(0, cache.T1 and 30 or 25, 0, cache.T1 and 15 or 25)
	Ruafimg.Image = "rbxassetid://92120582532478"
	...
	local colorB = tostring(Library_Function.Getcolor(cache.UIColor['Title Text Color'])[3])
	local color = colorR .. ',' .. colorG .. ',' .. colorB
	TextLabelMain.Text = "<font color=\"rgb("..color..")\">Nana Hub Free </font> " .."- Blox Fruits"
...
function sectionFunction.CreateButton(Setting, Callback)
	...
	ClickButton.TextColor3 = Color3.new(255, 255, 255)
	...
	ButtonGradient.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(230, 80, 160)),
